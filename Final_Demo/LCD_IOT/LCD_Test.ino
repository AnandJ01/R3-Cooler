...
//   // pinMode(ScreeenSD_CS, OUTPUT);

//   // // digitalWrite( firstScreeenSD_CS, LOW); // SD card chips select, must use GPIO 5 (ESP32 SS)
...
//   // digitalWrite(FourthScreenCS,LOW);
//   tft.fillScreen(TFT_BLACK);
//   drawSdJpeg("/testpicture.jpg", x, y);     // This draws a jpeg pulled off the SD Card

// //   digitalWrite(S0, HIGH);
// //   digitalWrite(S1, LOW);
// //   tft.fillScreen(TFT_BLACK);
// //   drawSdJpeg("/logo.jpg", x, y);     // This draws a jpeg pulled off the SD Card

// //   digitalWrite(S0, LOW);
// //   digitalWrite(S1, HIGH);
// //   tft.fillScreen(TFT_BLACK);
// //   drawSdJpeg("/tiger.jpg", 0, 0);     // This draws a jpeg pulled off the SD Card
